...
<section class="setting-sec">
      ...
      <section class="sec-accountedit-setting">
          <form action="account.php" method="POST">
            <div class="fname">
              <label for="first-name"><strong>First Name:</strong></label>
              <input type="text" id="first-name" name="first-name" value="Calista">
            </div><br>
            <div class="lname">
              <label for="last-name"><strong>Last Name:</strong></label>
              <input type="text" id="last-name" name="last-name" value="Perez">
            </div><br>
            <div class="uname">
              <label for="username"><strong>Username:</strong></label>
              <input type="text" id="username" name="username" value="Calie">
            </div><br>
            <div class="role">
            ...
            <div class="snumber">
              <label for="student-number"><strong>Student number:</strong></label>
              <input type="text" id="student-number" name="student-number" value="202205480">
            </div><br>
            <div class="course">
              <label for="course"><strong>Course:</strong></label>
              <input type="text" id="course" name="course" value="Bachelor of Science in Computer Science">
            </div><br>
            <div class="y&s">
              <label for="year-section"><strong>Year & Section:</strong></label>
              <input type="text" id="year-section" name="year-section" value="2nd year C">
            </div> 
            <p><br></p>   
