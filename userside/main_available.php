...
<section class="projector-section">
  ...
  <h2 class="texth2">Availability</h2>
...
<tbody>
  ...
  <tr>
    ...
    <td>Lecture 1</td>
    <td>Available</td>
    <td><button id="btn4" class="reserve-button" onclick="reserve('btn4', '3:00 PM - 5:00 PM')">Reserve</button></td>
      <button id="cancel4" class="cancel-button" onclick="cancelReservation('btn4', '3:00 PM - 5:00 PM')">Cancel</button>
  </tr>
  <tr>
    ...
    <td>Lecture 4</td>
    <td>Available</td>
    <td><button id="btn5" class="reserve-button" onclick="reserve('btn5', '5:00 PM - 7:00 PM')">Reserve</button></td>
    <button id="cancel5" class="cancel-button" onclick="cancelReservation('btn5', '5:00 PM - 7:00 PM')">Cancel</button>
  </tr>
  <td>7:00 AM - 9:00 AM</td>
  <td>Thursday</td>
    <td>HDMI</td>
    <td>Available</td>
    <td><button id="btn6" class="reserve-button" onclick="reserve('btn6', '7:00 AM - 9:00 AM')">Reserve</button></td>
    <button id="cancel6" class="cancel-button" onclick="cancelReservation('btn6', '7:00 AM - 9:00 AM')">Cancel</button>
  </tr>
  <tr>
    <td>9:00 AM - 11:00 AM</td>
    <td>Thursday</td>
  ...
  <td>Friday</td>
    <td>HDMI</td>
    <td>Available</td>
    <td><button id="btn8" class="reserve-button" onclick="reserve('btn8', '7:00 AM - 9:00 AM')">Reserve</button></td>
    <button id="cancel8" class="cancel-button" onclick="cancelReservation('btn8', '7:00 AM - 9:00 AM')">Cancel</button>
  </tr>
  <tr>
    <td>9:00 AM - 11:00 AM</td>
    <td>Friday</td>
    <td>Projector 2</td>
    <td>Available</td>
    <td><button id="btn9" class="reserve-button" onclick="reserve('btn9', '9:00 AM - 11:00 AM')">Reserve</button></td>
    <button id="cancel9" class="cancel-button" onclick="cancelReservation('btn9', '9:00 AM - 11:00 AM')">Cancel</button>
  </tr>
  <tr>
    <td>9:00 AM - 11:00 AM</td>
    <td>Saturday</td>
    <td>Projector 2</td>
    <td>Available</td>
    <td><button id="btn10" class="reserve-button" onclick="reserve('btn10', '9:00 AM - 11:00 AM')">Reserve</button></td>
    <button id="cancel10" class="cancel-button" onclick="cancelReservation('btn10', '9:00 AM - 11:00 AM')">Cancel</button>
  </tr>
  <tr>
</tbody>
</table>
