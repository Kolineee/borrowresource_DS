...
<tbody>
  <tr>
    ...
    <td>HDMI</td>
    <td>Available</td>
    <td><button id="btn1" class="borrowed-button" onclick="borrow('btn1', '7:00 AM - 9:00 AM')">Reserve</button></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Projector 2</td>
    <td>Available</td>
    <td><button id="btn2" class="borrowed-button" onclick="borrow('btn2', '9:00 AM - 11:00 AM')">Reserve</button></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Lecture 1</td>
    <td>Available</td>
    <td><button id="btn3" class="borrowed-button" onclick="borrow('btn3', '3:00 PM - 5:00 PM')">Reserve</button></td>
  </tr>
  <tr>
    ...
    <td>Lecture 4</td>
    <td>Available</td>
    <td><button id="btn4" class="borrowed-button" onclick="borrow('btn4', '5:00 PM - 7:00 PM')">Reserve</button></td>
  </tr>
  <tr>
    <td>1:00 PM - 3:00 PM</td>
    <td>Tuesday</td>
