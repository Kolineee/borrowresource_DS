...
<section class="projector-section">
  <div class="containerr">
    <div class="searchh-bar">
        <div class="drppdown">
            ...
            <div class="drppdown-content">
                <a href="projector 2.php">Monday</a>
                <a href="projector 2 -TUE.php">Tuesday</a>
                <a href="projector 2 - WED.php">Wednesday</a>
                <a href="projector 2-THU.php">Thursday</a>
                <a href="#">Friday</a>
                <a href="#">Saturday</a>
            </div>
        </div>
    ...
    <h2>Projector 2 Availability - Tuesday</h2>

<table>
  <thead>
    <tr>
      <th>Time Slot</th>
      <th>Projector 2 Availability</th>
      <th>Action</th>
    </tr>
  </thead>
  <tbody>
